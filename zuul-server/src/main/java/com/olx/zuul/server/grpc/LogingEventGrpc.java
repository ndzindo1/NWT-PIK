package com.olx.zuul.server.grpc;
...
public final class LogingEventGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.olx.zuul.server.grpc.Log.Event,
      com.olx.zuul.server.grpc.Log.Empty> getLogEventMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "LogEvent",
      requestType = com.olx.zuul.server.grpc.Log.Event.class,
      responseType = com.olx.zuul.server.grpc.Log.Empty.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.olx.zuul.server.grpc.Log.Event,
      com.olx.zuul.server.grpc.Log.Empty> getLogEventMethod() {
    io.grpc.MethodDescriptor<com.olx.zuul.server.grpc.Log.Event, com.olx.zuul.server.grpc.Log.Empty> getLogEventMethod;
      ...
      synchronized (LogingEventGrpc.class) {
        if ((getLogEventMethod = LogingEventGrpc.getLogEventMethod) == null) {
          LogingEventGrpc.getLogEventMethod = getLogEventMethod = 
              io.grpc.MethodDescriptor.<com.olx.zuul.server.grpc.Log.Event, com.olx.zuul.server.grpc.Log.Empty>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "LogingEvent", "LogEvent"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.olx.zuul.server.grpc.Log.Event.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.olx.zuul.server.grpc.Log.Empty.getDefaultInstance()))
  ...
  public static abstract class LogingEventImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void logEvent(com.olx.zuul.server.grpc.Log.Event request,
        io.grpc.stub.StreamObserver<com.olx.zuul.server.grpc.Log.Empty> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.olx.zuul.server.grpc.Log.Event,
                com.olx.zuul.server.grpc.Log.Empty>(
  ...
  public static final class LogingEventBlockingStub extends io.grpc.stub.AbstractStub<LogingEventBlockingStub> {
    ...
    /**
     */
    public com.olx.zuul.server.grpc.Log.Empty logEvent(com.olx.zuul.server.grpc.Log.Event request) {
  ...
  public static final class LogingEventFutureStub extends io.grpc.stub.AbstractStub<LogingEventFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.olx.zuul.server.grpc.Log.Empty> logEvent(
        com.olx.zuul.server.grpc.Log.Event request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_LOG_EVENT:
          serviceImpl.logEvent((com.olx.zuul.server.grpc.Log.Event) request,
              (io.grpc.stub.StreamObserver<com.olx.zuul.server.grpc.Log.Empty>) responseObserver);
          break;
        default:
  ...
  private static abstract class LogingEventBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.olx.zuul.server.grpc.Log.getDescriptor();
    }
